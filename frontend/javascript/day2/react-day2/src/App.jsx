...
const LoadingFallback = () => (
  <div className="h-full w-full flex items-center justify-center">
    <div className="space-y-4 text-center">
      ...
      <p className="text-muted animate-pulse">Loading logic...</p>
    </div>
  </div>
);
                ...
                <Suspense fallback={<LoadingFallback />}>
                  <Routes>
                    ...
                    <Route path="/q12/dashboard" element={
                      ...
                      <Route path="profile" element={<div className="p-8"><h2>User Profile</h2><p className="text-muted">This is a nested protected route using Outlet.</p></div>} />
                      <Route path="settings" element={<div className="p-8"><h2>Account Settings</h2><p className="text-muted">Manage your preferences here.</p></div>} />
                      <Route index element={<div className="p-8"><p>Welcome to your secure dashboard. Choose an option above.</p></div>} />
                    </Route>
                    ...
                    <Route path="/q14" element={
                      <div className="space-y-12">
                         <h2 className="text-3xl font-bold gradient-text">Q14. Error Boundary Demo</h2>
                         <p className="text-muted">The component below is wrapped in an Error Boundary.</p>
                         <ErrorBoundary>
                            <BuggyComponent />
                         </ErrorBoundary>
                      </div>
                    ...
                    <Route path="/q18" element={<Navigate to="/q12/dashboard" replace />} /> {/* Redirecting to Q12 as it's the same auth flow requirement */}
                    <Route path="/q19" element={<Q19 />} />
                    <Route path="/q20" element={<Q20 />} />

                    <Route path="*" element={<div className="text-center py-20"><h1 className="text-6xl font-bold mb-4">404</h1><p>Task not implementation yet or wrong route.</p><button className="btn btn-primary mt-6" onClick={() => window.location.href='/'}>Back to Dashboard</button></div>} />
                  </Routes>
                </Suspense>
              </main>
            </Router>
